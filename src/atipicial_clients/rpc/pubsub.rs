...
use crate::atipicial_clients::{JsonRpcProvider, RpcClient};
...
/// Streams data from an installed filter via `atipicial_subscribe`
pub struct SubscriptionStream<'a, P: PubsubClient, R: DeserializeOwned> {
	/// The subscription's installed id on the atipicial node
	pub id: U256,
