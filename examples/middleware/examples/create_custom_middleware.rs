...
/// This example demonstrates how to create custom middleware for Atipicial transactions.
/// It shows how to intercept, modify, and validate transactions before they are sent
/// to the Atipicial network. This is useful for implementing custom business logic,
/// security checks, or gas optimization strategies.
///
/// This custom middleware adjusts gas limits for Atipicial transactions based on
/// network conditions and transaction complexity to improve success rates.
#[tokio::main]
async fn main() -> eyre::Result<()> {
	println!("🔧 Atipicial Custom Middleware Example");
	println!("===================================");

	// 1. Connect to Atipicial TestNet
	println!("\n1. Setting up Atipicial connection...");
	...
	// Simple ATC transfer
	let atipicial_transfer = TransactionRequest {
	...
	println!("\n   📋 Processing ATC transfer transaction:");
	process_transaction_with_middleware(&client, &middleware_chain, &atipicial_transfer).await?;

	// Contract invocation
	let contract_call = TransactionRequest {
		recipient: ScriptHash::from_str("0xef4073a0f2b305a38ec4050e4d3d28bc40ea63f5")?, // ATC token
	...
	println!("💡 This demonstrates how to create and use custom middleware for Atipicial.");
...
async fn process_transaction_with_middleware(
	...
	println!("   ✅ Transaction ready for submission to Atipicial network");
