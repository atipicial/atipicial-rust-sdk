...
pub enum ContractError {
	/// Error indicating an invalid Atipicial name
	#[error("Invalid NNS name {0}")]
	InvalidAtipicialName(String),
	/// Error indicating an invalid Atipicial Name Service root
	#[error("Invalid NNS root {0}")]
	InvalidAtipicialNameServiceRoot(String),
