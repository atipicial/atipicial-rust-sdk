...
const FeatureList = [
  {
    ...
    description: (
      <>
        Curated guides, templates, and examples to speed up Atipicial development.
  ...
  },
  {
    ...
    description: (
      <>
        ...
        and enterprise-grade reliability. Build robust Atipicial applications 
        with confidence.
      </>
    ),
  },
        ...
        <div className="row">
          <div className="col col--12">
            <h2 className={styles.featuresTitle}>
              Why Choose AtipicialRust?
            </h2>
            <p className={styles.featuresSubtitle}>
              Built by developers, for developers. AtipicialRust provides everything you need 
              to build production-ready Atipicial applications.
            </p>
          </div>
        </div>
        <div className="row">
