...
//! # AtipicialFs Core Types
//!
//! This module defines the core data types used in the AtipicialFs system.

use derive_more::{Display, From};
use serde::{Deserialize, Serialize};
use std::collections::HashMap;

/// Unique identifier for a container in AtipicialFs
#[derive(Debug, Clone, PartialEq, Eq, Hash, Serialize, Deserialize, Display, From)]
pub struct ContainerId(pub String);

/// Unique identifier for an object in AtipicialFs
#[derive(Debug, Clone, PartialEq, Eq, Hash, Serialize, Deserialize, Display, From)]
pub struct ObjectId(pub String);

/// Unique identifier for a user in the AtipicialFs network
#[derive(Debug, Clone, PartialEq, Eq, Hash, Serialize, Deserialize, Display, From)]
...
/// Metadata attributes for AtipicialFs objects
...
/// Access permissions for AtipicialFs containers and objects
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Session token for authenticating with AtipicialFs
#[derive(Debug, Clone, Serialize, Deserialize)]
