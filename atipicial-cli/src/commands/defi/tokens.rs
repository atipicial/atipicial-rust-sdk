#![allow(dead_code)]
// Token operations for Atipicial CLI
//
// This module provides commands for interacting with AEP-17 tokens on the Atipicial blockchain.
...
use atipicial::{
	...
	atipicial_codec::AtipicialSerializable,
...
fn ensure_account_loaded(state: &mut CliState) -> Result<atipicial::atipicial_protocol::Account, CliError> {
	state.get_account()
}

/// Get token information
///
/// Retrieves detailed information about a AEP-17 token including name,
...
/// compatibility issues being addressed between the wallet and atipicial libraries.
///
/// # Arguments
