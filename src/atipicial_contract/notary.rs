//! Notary native contract for Atipicial.
//!
//! The Notary contract provides assistance for forming multisignature transactions.
//! It was introduced in Atipicial 3.9 (HF_Echidna) and allows users to deposit GAS as collateral
//! for notary services.
//!
//! This contract supports AEP-27 (Token callbacks) and AEP-30 (Native contract interface) standards.
...
use crate::{
	...
	atipicial_contract::{checked_vm_integer, traits::SmartContractTrait, ContractError},
	atipicial_types::{
...
///
/// This contract was introduced in Atipicial 3.9 (HF_Echidna).
...
impl<'a, P: JsonRpcProvider + 'static> NotaryContract<'a, P> {
	...
	pub async fn withdraw(
		...
		let params = match to {
			...
			None => vec![from.into(), crate::atipicial_types::ContractParameter::any()],
		};
	...
	/// # Returns
	///
	/// A list of supported standards: AEP-27, AEP-30 (after HF_Faun)
