//! This module contains implementations for different types of signers in the ATC blockchain.
//!
//! It includes:
...
//! # Usage
//!
//! To use the signers in your ATC blockchain transactions:
//!
//! 1. Import the necessary types:
//!    ```rust
//!    use atipicial::atipicial_builder::{AccountSigner, ContractSigner, TransactionSigner, Signer};
//!    ```
//!
//! 2. Create a signer based on your needs:
//!    ```rust,no_run
//!    use atipicial::atipicial_protocol::{Account, AccountTrait};
//!    use atipicial::atipicial_builder::{AccountSigner, ContractSigner, TransactionSigner, WitnessScope};
//!    use atipicial::prelude::H160;
//!    use std::str::FromStr;
//!
...
//!    ```rust,no_run
//!    # use atipicial::atipicial_builder::{TransactionBuilder, AccountSigner};
//!    # use atipicial::atipicial_protocol::{Account, AccountTrait};
//!    # let account = Account::from_wif("YOUR_WIF_HERE").unwrap();
//!    # let account_signer = AccountSigner::called_by_entry(&account).unwrap();
...
//!    ```rust,no_run
//!    # use atipicial::atipicial_builder::{Signer, AccountSigner};
//!    # use atipicial::atipicial_protocol::{Account, AccountTrait};
//!    # let account = Account::from_wif("YOUR_WIF_HERE").unwrap();
//!    # let account_signer = AccountSigner::called_by_entry(&account).unwrap();
