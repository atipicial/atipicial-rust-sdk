...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
	...
	let wallet = wallet.with_network(AtipicialNetwork::TestNet.to_magic());
	...
	let backup_path = PathBuf::from("my_atipicial_wallet_backup.json");
