...
This directory contains comprehensive tests for the AtipicialRust SDK, organized by type and scope.
...
- `contracts/` - Test contract AEF files and manifests
...
export ATC_TESTNET_URL="https://testnet1.atipicial.com:443"
export ATC_MAINNET_URL="https://mainnet1.atipicial.com:443"
#
# (Optional) Explicit RPC endpoint overrides (synonyms supported by some tests/tools)
export ATC_TESTNET_RPC_URL="$ATC_TESTNET_URL"
export ATC_MAINNET_RPC_URL="$ATC_MAINNET_URL"

# Skip tests that require live RPC/network access
export ATCRUST_SKIP_NETWORK_TESTS=1
...
- **Local**: Atipicial-Express for development
...
- **Version compatibility**: Support multiple Atipicial versions
...
- [Atipicial Testing Best Practices](https://docs.atipicial.com/develop/test)
