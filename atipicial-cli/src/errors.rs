...
/// Unified error type for the Atipicial CLI.
///
...
impl From<atipicial::atipicial_builder::BuilderError> for CliError {
	fn from(error: atipicial::atipicial_builder::BuilderError) -> Self {
		CliError::Builder(error.to_string())
	}
}

// Implement From trait for TransactionError
impl From<atipicial::atipicial_builder::TransactionError> for CliError {
	fn from(error: atipicial::atipicial_builder::TransactionError) -> Self {
		CliError::Transaction(error.to_string())
	}
}

// Implement From trait for ProviderError
impl From<atipicial::atipicial_clients::ProviderError> for CliError {
	fn from(error: atipicial::atipicial_clients::ProviderError) -> Self {
