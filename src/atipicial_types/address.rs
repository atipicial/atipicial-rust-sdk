...
use crate::{
	...
	atipicial_crypto::utils::FromHexString,
	atipicial_error::legacy_error::AtipicialError,
	atipicial_types::{ScriptHash, ScriptHashExtension, StringExt, TypeError},
};
...
pub trait AddressExtension {
	...
	///
	/// ```
	/// use atipicial::atipicial_types::AddressExtension;
	/// // Example with a valid Atipicial address format
