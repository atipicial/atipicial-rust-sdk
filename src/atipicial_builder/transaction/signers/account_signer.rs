...
/// Represents an account signer in the ATC blockchain.
///
...
impl AtipicialSerializable for AccountSigner {
	type Error = TransactionError;

	fn size(&self) -> usize {
		let mut size: usize = AtipicialConstants::HASH160_SIZE as usize + 1;
