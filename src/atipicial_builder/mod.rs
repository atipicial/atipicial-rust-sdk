//! # Atipicial Builder Module
//!
//! Advanced tooling for constructing Atipicial transactions and smart contract scripts.
//!
//! ## Overview
//!
//! The atipicial_builder module provides a comprehensive set of utilities for constructing
//! and manipulating Atipicial transactions and scripts. It offers a flexible API for
...
//! - **Opcode Support**: Full support for Atipicial VM opcodes
...
//!
//! ```no_run
//! use atipicial::atipicial_builder::{ScriptBuilder, Signer, WitnessScope, TransactionSigner};
...
//!     script_builder.push_data("Hello Atipicial!".as_bytes().to_vec());
