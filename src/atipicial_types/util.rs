...
///
/// ```
/// use atipicial::atipicial_types::parse_string_u64;
/// let decimal = "12345";
...
/// use atipicial::atipicial_types::parse_string_u256;
...
///
/// ```
/// use atipicial::atipicial_types::{parse_address, ScriptHash};
...
/// use atipicial::atipicial_types::encode_string_h160;
...
/// ```
/// use primitive_types::H160;
/// use atipicial::atipicial_types::parse_string_h160;
...
/// use atipicial::atipicial_types::parse_string_h256;
/// let hex_str = "0x123456";
...
/// ```
/// use primitive_types::H256;
/// use atipicial::atipicial_types::encode_string_h256;
...
/// ```
/// use primitive_types::U256;
/// use atipicial::atipicial_types::encode_string_u256;
...
/// ```
/// use primitive_types::U256;
/// use atipicial::atipicial_types::encode_vec_string_vec_u256;
...
/// ```
/// use primitive_types::U256;
/// use atipicial::atipicial_types::parse_vec_string_vec_u256;
...
/// use atipicial::atipicial_types::h256_to_u256;
...
///
/// ```
/// use atipicial::atipicial_types::bytes_to_string;
...
///
/// ```
/// use atipicial::atipicial_types::string_to_bytes;
...
/// ```
/// use primitive_types::U256;
/// use atipicial::atipicial_types::u256_sqrt;
...
/// ```
/// use primitive_types::U256;
/// use atipicial::atipicial_types::u256_min;
/// let a = U256::from(1);
/// let b = U256::from(2);
...
///
/// ```
/// use atipicial::atipicial_types::vec_to_array32;
/// let vec = vec![0_u8; 32];
...
///
/// ```
/// use atipicial::atipicial_types::var_size;
...
pub trait ToBase58 {
	...
	///
	/// ```
	/// use atipicial::atipicial_types::ToBase58;
	/// let bytes = [1, 2, 3];
...
pub trait ToBase64 {
	...
	///
	/// ```
	/// use atipicial::atipicial_types::ToBase64;
	/// let bytes = [1, 2, 3];
