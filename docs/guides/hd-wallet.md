...
AtipicialRust ships a BIP-39/44 compatible HD wallet in `atipicial::sdk::hd_wallet`.
...
scrypt (Atipicial defaults) + AES-256. This is intended for “encrypt at rest” use cases.
