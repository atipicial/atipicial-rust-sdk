//! Error handling utilities for the Atipicial SDK.
...
/// use atipicial::atipicial_utils::error::option_to_result;
///
/// let value: Option<u32> = Some(42);
/// let result = option_to_result(value, || AtipicialError::validation("value", None::<&str>, "Value is None"));
...
/// ```rust
/// use atipicial::prelude::*;
/// use atipicial::atipicial_utils::error::with_context;
///
/// let result: Result<u32, AtipicialError> = Err(AtipicialError::validation("value", None::<&str>, "Original error"));
/// let result_with_context = with_context(result, || "Additional context", |msg| AtipicialError::validation("value", None::<&str>, &msg));
...
/// ```
/// use atipicial::prelude::*;
/// use atipicial::atipicial_utils::error::result_to_option;
///
/// let result: Result<u32, AtipicialError> = Ok(42);
...
/// ```
/// use atipicial::prelude::*;
/// use atipicial::atipicial_utils::error::retry;
/// use std::time::Duration;
///
/// async fn fallible_operation() -> Result<u32, AtipicialError> {
///     // Some operation that might fail
///     Ok(42)
/// }
///
/// # async fn example() -> Result<(), AtipicialError> {
/// let result = retry(
