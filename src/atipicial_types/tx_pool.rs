...
///
/// See [here](https://geth.atipicial.com/docs/rpc/ns-txpool#txpool_content) for more details
...
///
/// See [here](https://geth.atipicial.com/docs/rpc/ns-txpool#txpool_inspect) for more details
#[derive(Debug, Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
...
///
/// See [here](https://geth.atipicial.com/docs/rpc/ns-txpool#txpool_status) for more details
