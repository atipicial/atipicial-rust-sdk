//! Atipicial Contract Methods, ABI and Structured Data Example
//!
//! This example demonstrates how to interact with Atipicial smart contracts
...
/// Represents a Atipicial contract ABI method definition
#[derive(Debug, Clone)]
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
	println!("📋 Atipicial Contract Methods, ABI and Structured Data Example");
	println!("==========================================================");

	// 1. Connect to Atipicial TestNet
	println!("\n1️⃣ Connecting to Atipicial TestNet...");
	...
	// 2. Set up contract ABI for GAS token (AEP-17)
	...
	let transfer = TokenTransfer {
		...
		data: Some(b"Hello Atipicial!".to_vec()),
	};
	...
	let swap = SwapOperation {
		...
		token_out: "ef4073a0f2b305a38ec4050e4d3d28bc40ea63f5".to_string(), // ATC
		amount_in: 10_00000000,                                           // 10 GAS
		min_amount_out: 1_00000000,                                       // 1 ATC minimum
	...
	println!("       Min Amount Out: {} ATC", swap.min_amount_out as f64 / 100_000_000.0);
	...
	println!("   using structured data and ABI-based method calls in Atipicial");
