...
**Tech Stack:** Rust 2021, Cargo unit tests, `thiserror`, existing Atipicial SDK conversion traits.

### Task 1: Add failing tests for safe address/hash conversions

**Files:**
- Modify: `src/atipicial_types/address.rs`
- Modify: `src/atipicial_types/address_or_scripthash.rs`

**Step 1: Write failing tests**
- Add a test that `from_script_hash` returns the known Atipicial address for a known script hash.
...
Run: `cargo test -p atipicial atipicial_types::address::tests::test_from_script_hash --quiet`
Run: `cargo test -p atipicial atipicial_types::address_or_scripthash --quiet`
...
**Files:**
- Modify: `src/atipicial_builder/utils.rs`
- Test: `src/atipicial_builder/utils.rs`
...
Run: `cargo test -p atipicial atipicial_builder::utils --quiet`
...
Run: `cargo test -p atipicial --lib --quiet`
