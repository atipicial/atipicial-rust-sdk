...
/// Atipicial Middleware Builder Example
///
/// This example demonstrates how to build custom middleware patterns for Atipicial
/// transactions and contract interactions. Unlike Ethereum middleware that works
/// with transaction pools, Atipicial middleware focuses on transaction validation,
/// script building, and fee optimization.
#[tokio::main]
async fn main() -> Result<(), Box<dyn std::error::Error>> {
	println!("🔧 Atipicial Middleware Builder Example");
	println!("===================================");

	// 1. Build basic RPC client
	println!("\n1. Building basic Atipicial client...");
	...
	let token_middleware = TokenInteractionMiddleware::new(vec![gas_token, atipicial_token]);
	println!(
	...
	println!("\n✅ Atipicial middleware builder example completed!");
