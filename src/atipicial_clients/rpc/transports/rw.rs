...
/// One is used for _write_ operations that consume gas `["atipicial_sendTransaction",
/// "atipicial_sendRawTransaction"]`
///
...
impl<Read, Write> RwClient<Read, Write> {
	...
	///
	/// ```no_run
	/// use atipicial::atipicial_clients::{HttpProvider, RwClient};
	/// use url::Url;
	///
	/// # #[cfg(feature = "ws")]
	...
	///     # #[cfg(feature = "ws")]
	///     let ws = atipicial::atipicial_clients::Ws::connect("ws://localhost:10334/ws").await?;
	///     # #[cfg(feature = "ws")]
