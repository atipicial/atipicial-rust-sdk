//! Definitions of Native Contract script hashes for Atipicial.
//!
//! This module provides constants for all native contracts available on the Atipicial blockchain.
...
/// ATC Token native contract script hash
...
/// Atipicial Name Service contract script hash (MainNet).
///
...
mod tests {
	...
	fn test_native_contract_known_hashes() {
		assert_eq!(ATC_TOKEN, "0xef4073a0f2b305a38ec4050e4d3d28bc40ea63f5");
