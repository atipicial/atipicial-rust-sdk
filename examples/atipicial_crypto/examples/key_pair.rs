use atipicial::{
	atipicial_crypto::{HashableForVec, KeyPair},
	atipicial_protocol::{Account, AccountTrait},
};

/// Production-ready comprehensive example demonstrating Atipicial key pair operations
/// including generation, import, export, signing, and verification
fn main() -> Result<(), Box<dyn std::error::Error>> {
	println!("🔐 Atipicial Comprehensive Key Pair Management Example");
	println!("===================================================");
	...
	println!("\n2. 👤 Creating Atipicial accounts from key pairs...");
	...
	println!("✅ Created Atipicial accounts successfully");
...
fn export_key_examples(account: &Account) -> Result<(), Box<dyn std::error::Error>> {
	...
	println!("   🔒 AEP-2 Export:   Available through wallet encryption features");
...
fn import_key_examples() -> Result<(), Box<dyn std::error::Error>> {
	...
	println!("   🔒 AEP-2 Import:   Available through wallet decryption features");
...
fn signature_verification_example(key_pair: &KeyPair) -> Result<(), Box<dyn std::error::Error>> {
	let message = b"Hello Atipicial Blockchain! This is a test message for signature verification.";

	// Hash the message (Atipicial uses SHA256 for message hashing)
	...
	let tampered_message =
		b"Hello Atipicial Blockchain! This is a TAMPERED message for signature verification.";
