...
///
/// ```rust,no_run
/// use atipicial::atipicial_clients::{AtipicialHttpClient, APITrait};
///
/// async fn example(client: &AtipicialHttpClient) -> Result<(), Box<dyn std::error::Error>> {
...
///
/// ```rust
/// use atipicial::atipicial_clients::ProviderResult;
///
