...
use atipicial::prelude::{Address, Bytes, ScriptHashExtension};
...
impl Hash for AddressOrScriptHash {
	...
	/// use atipicial::atipicial_types::AddressOrScriptHash;
...
impl From<Bytes> for AddressOrScriptHash {
	...
	///
	/// ```
	/// use atipicial::atipicial_types::{AddressOrScriptHash, Bytes};
...
impl AddressOrScriptHash {
	...
	/// // The address will be a valid Atipicial address derived from the script hash
