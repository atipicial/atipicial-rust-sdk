...
//! `atipicial_builder::script::ScriptBuilder`.
...
/// Calculator for Atipicial transaction fees.
///
...
impl FeeCalculator {
    /// Creates a new FeeCalculator with default Atipicial fee parameters.
    pub fn new() -> Self {
        Self {
...
///
/// ```rust,ignore
/// use atipicial::atipicial_builder::transaction::production_transaction_builder::*;
///
