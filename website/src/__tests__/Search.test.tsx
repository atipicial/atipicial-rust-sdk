...
describe('Search Component', () => {
  ...
  it('shows search results when typing', () => {
    ...
    expect(screen.getByText('Create and manage Atipicial wallets securely with the SDK.')).toBeInTheDocument();
  });
  ...
  it('filters results based on query', () => {
    ...
    expect(screen.getByText('AEP-17 Tokens')).toBeInTheDocument();
