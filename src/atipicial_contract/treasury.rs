//! Treasury native contract for Atipicial.
//!
//! The Treasury contract manages treasury funds in the Atipicial blockchain.
//! It was introduced in Atipicial 3.9 (HF_Faun) and implements AEP-26, AEP-27, and AEP-30 standards.
//!
//! The Treasury contract can receive AEP-17 and AEP-11 tokens and is controlled
//! by the committee.
...
use crate::{
	...
	atipicial_contract::{traits::SmartContractTrait, ContractError},
	atipicial_types::{
...
///
/// This contract was introduced in Atipicial 3.9 (HF_Faun) and supports:
/// - AEP-26 (Treasury standard)
/// - AEP-27 (Token callbacks)
/// - AEP-30 (Native contract interface)
///
/// The Treasury can receive both AEP-17 (fungible) and AEP-11 (non-fungible) tokens.
...
impl<'a, P: JsonRpcProvider + 'static> TreasuryContract<'a, P> {
	...
	/// # Returns
	///
	/// A list of supported standards: AEP-26, AEP-27, AEP-30
	pub fn supported_standards() -> Vec<&'static str> {
		vec!["AEP-26", "AEP-27", "AEP-30"]
	}
}
...
mod tests {
	use super::*;
	use crate::atipicial_clients::MockProvider;
	...
	fn test_treasury_supported_standards() {
		...
		assert!(standards.contains(&"AEP-26"));
		assert!(standards.contains(&"AEP-27"));
		assert!(standards.contains(&"AEP-30"));
	}
