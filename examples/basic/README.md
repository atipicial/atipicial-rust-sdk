...
These examples cover fundamental Atipicial operations. Start here if you're new to Atipicial or AtipicialRust.

## 📚 Examples

### 01. Network Connection (`01_connect_to_network.rs`)
Learn how to connect to Atipicial nodes and check network status.
...
**What you'll learn:**
- Checking ATC and GAS balances
- Querying AEP-17 token balances
...
Send ATC and GAS between addresses.
