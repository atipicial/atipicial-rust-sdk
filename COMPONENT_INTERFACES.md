...
# AtipicialRust SDK - Component Interface Design

## 1. Component Overview

This document defines the interfaces between major components of the AtipicialRust SDK, ensuring loose coupling and high cohesion.
...
/// AEP-17 token interface
#[async_trait]
pub trait Aep17Interface: ContractInterface {
    /// Get token symbol
...
/// AEP-11 NFT interface
#[async_trait]
pub trait Aep11Interface: ContractInterface {
...
/// 
/// This interface provides methods for interacting with Atipicial blockchain nodes
