...
//! # AtipicialFs Object Operations
//!
//! This module provides functionality for managing AtipicialFs objects.
//! Objects in AtipicialFs are the actual data files stored in containers.

use chrono::{DateTime, Utc};
use serde::{Deserialize, Serialize};

use crate::atipicial_fs::types::{Attributes, ContainerId, ObjectId, ObjectType, OwnerId};

/// Represents a storage object in AtipicialFs
