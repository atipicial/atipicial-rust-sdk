// Example SGX Enclave using AtipicialRust SDK
...
use atipicial::atipicial_sgx::enclave::{SgxEnclave, EnclaveConfig};
use atipicial::atipicial_sgx::networking::SgxNetworking;
...
/// Sign a Atipicial transaction inside the enclave
#[no_mangle]
pub extern "C" fn atipicial_sign_transaction(
    data: *const u8,
    data_len: usize,
    signature: *mut u8,
) -> sgx_status_t {
...
#[no_mangle]
pub extern "C" fn atipicial_verify_signature(
    data: *const u8,
    data_len: usize,
    signature: *const u8,
    public_key: *const u8,
...
#[no_mangle]
pub extern "C" fn atipicial_calculate_hash(
    data: *const u8,
    data_len: usize,
    hash: *mut u8,
) -> sgx_status_t {
...
#[no_mangle]
pub extern "C" fn atipicial_generate_keypair(
    private_key: *mut u8,
    public_key: *mut u8,
) -> sgx_status_t {
...
#[no_mangle]
pub extern "C" fn atipicial_encrypt_wallet(
...
#[no_mangle]
pub extern "C" fn atipicial_decrypt_wallet(
...
#[no_mangle]
pub extern "C" fn atipicial_remote_attestation(
    sp_pub_key: *const u8,
    quote: *mut u8,
    quote_len: *mut usize,
) -> sgx_status_t {
    ...
    let user_data = b"ATC_ENCLAVE_V1";
