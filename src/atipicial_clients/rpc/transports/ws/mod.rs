...
use crate::atipicial_clients::{JsonRpcProvider, ProviderError, PubsubClient, RpcClient};
...
impl RpcClient<WsClient> {
	...
	///
	/// ```no_run
	/// use atipicial::atipicial_clients::{APITrait, RpcClient, Ws};
	///
	...
	///
	/// ```no_run
	/// use atipicial::atipicial_clients::{APITrait, Authorization, ConnectionDetails, RpcClient, Ws};
	///
	/// # async fn t() -> Result<(), Box<dyn std::error::Error>> {
