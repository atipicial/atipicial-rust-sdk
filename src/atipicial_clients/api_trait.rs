...
use crate::{
	...
	config::atipicial_config_lock,
	atipicial_clients::{JsonRpcProvider, ProviderError, RpcClient},
	atipicial_protocol::{
		ApplicationLog, MemPoolDetails, AtipicialAddress, AtipicialBlock, AtipicialNetworkFee, AtipicialVersion,
		Aep11Balances, Aep11Transfers, Aep17Balances, Aep17Transfers, Peers, Plugin, RTransaction,
...
pub trait APITrait: Sync + Send + Debug {
	...
	fn nns_resolver(&self) -> H160 {
		atipicial_config_lock().nns_resolver
	}

	/// Returns the block interval in milliseconds.
	fn block_interval(&self) -> u32 {
		atipicial_config_lock().milliseconds_per_block
	}
	...
	fn max_valid_until_block_increment(&self) -> u32 {
		atipicial_config_lock().get_max_valid_until_block_increment()
	}
	...
	async fn get_block(&self, block_hash: H256, full_tx: bool) -> Result<AtipicialBlock, Self::Error>;
	...
	async fn get_block_header(&self, block_hash: H256) -> Result<AtipicialBlock, Self::Error>;

	async fn get_block_header_by_index(&self, index: u32) -> Result<AtipicialBlock, Self::Error>;
	...
	async fn get_version(&self) -> Result<AtipicialVersion, Self::Error>;
	...
	async fn import_priv_key(&self, priv_key: String) -> Result<AtipicialAddress, Self::Error>;

	async fn calculate_network_fee(&self, hex: String) -> Result<AtipicialNetworkFee, Self::Error>;

	async fn list_address(&self) -> Result<Vec<AtipicialAddress>, Self::Error>;
	...
	async fn get_aep17_balances(&self, script_hash: H160) -> Result<Aep17Balances, Self::Error>;

	async fn get_aep17_transfers(&self, script_hash: H160) -> Result<Aep17Transfers, Self::Error>;
	...
	async fn get_aep17_transfers_from(
		...
		script_hash: H160,
		from: u64,
	) -> Result<Aep17Transfers, Self::Error>;
	...
	async fn get_aep11_balances(&self, script_hash: H160) -> Result<Aep11Balances, Self::Error>;

	// AEP-11 methods

	async fn get_aep11_transfers(&self, script_hash: H160) -> Result<Aep11Transfers, Self::Error>;

	async fn get_aep11_transfers_from(
		&self,
		script_hash: H160,
		from: u64,
	) -> Result<Aep11Transfers, Self::Error>;
	...
	async fn get_block_by_hash(&self, hash: &str, full_tx: bool) -> Result<AtipicialBlock, Self::Error>;

	async fn broadcast_address(&self) -> Result<bool, Self::Error>;

	async fn broadcast_block(&self, block: AtipicialBlock) -> Result<bool, Self::Error>;
	...
	async fn get_block_by_index(&self, index: u32, full_tx: bool) -> Result<AtipicialBlock, Self::Error>;
	...
	async fn import_private_key(&self, wif: String) -> Result<AtipicialAddress, Self::Error>;

	async fn get_block_header_hash(&self, hash: H256) -> Result<AtipicialBlock, Self::Error>;
