		...
		Config {
			networks: vec![
				NetworkConfig {
					...
					rpc_url: "http://seed1.atipicial.com:10333".to_string(),
				},
				NetworkConfig {
			...
			wallet_path: None,
			auto_connect: false,
			atipicialfs: AtipicialFsConfig {
				endpoints: vec![
					AtipicialFsEndpoint {
						name: "mainnet-grpc".to_string(),
						url: "https://grpc.fs.atipicial.com".to_string(),
						network: "mainnet".to_string(),
						endpoint_type: "grpc".to_string(),
					},
					AtipicialFsEndpoint {
						name: "testnet-grpc".to_string(),
						url: "https://grpc.testnet.fs.atipicial.com".to_string(),
						network: "testnet".to_string(),
						endpoint_type: "grpc".to_string(),
					},
					AtipicialFsEndpoint {
						name: "mainnet-http".to_string(),
						url: "https://http.fs.atipicial.com".to_string(),
						network: "mainnet".to_string(),
						endpoint_type: "http".to_string(),
					},
					AtipicialFsEndpoint {
						name: "testnet-http".to_string(),
						url: "https://http.testnet.fs.atipicial.com".to_string(),
						network: "testnet".to_string(),
						endpoint_type: "http".to_string(),
					},
				],
...
pub fn get_config_dir() -> Result<PathBuf, CliError> {
	...
	let config_dir = PathBuf::from(home).join(".atipicial-cli");
