//! Contract Manifest types for Atipicial smart contracts.
//!
...
//! It is required for all Atipicial smart contracts and is stored on-chain alongside the contract's bytecode.
//!
//! # Purpose
//!
//! The manifest serves several critical functions:
//!
//! - **Contract Identification**: Provides the contract name and supported standards (e.g., AEP-11, AEP-17)
...
use crate::{
	atipicial_types::ContractParameter2,
	prelude::{deserialize_wildcard, serialize_wildcard},
	TypeError,
};
use atipicial::prelude::{ContractParameter, ContractParameterType};

/// The contract manifest describing a Atipicial smart contract's metadata, interface, and permissions.
///
/// The manifest is a core component of every Atipicial smart contract. It declares the contract's
...
/// - [`supported_standards`](Self::supported_standards): List of AEP standards the contract implements
...
/// # Serialization
///
/// This struct supports serialization to/from JSON format as defined by the Atipicial specification.
...
pub struct ContractManifest {
	...
	/// List of Atipicial Enhancement Proposals (AEPs) this contract supports.
	///
	...
	/// of allowed method names (or wildcard for all methods). The Atipicial runtime
...
impl ContractManifest {
	...
	/// * `supported_standards` - List of supported AEP standards
	...
	///
	/// ```
	/// use atipicial::atipicial_types::contract::ContractManifest;
	///
...
/// is allowed to call. The Atipicial runtime enforces these permissions during
...
impl ContractPermission {
	...
	///
	/// ```
	/// use atipicial::atipicial_types::contract::ContractPermission;
	///
