...
AtipicialRust is Copyright © 2020-2025 R3E Network and contributors.

## License

AtipicialRust is dual-licensed under:

- MIT License ([LICENSE-MIT](https://github.com/r3e-network/atipicial-rust-sdk/blob/master/LICENSE-MIT))
- Apache License, Version 2.0 ([LICENSE-APACHE](https://github.com/r3e-network/atipicial-rust-sdk/blob/master/LICENSE-APACHE))

## Copyright Format

When adding new files to the AtipicialRust project, please include the appropriate copyright header:
...
6. atipicial-cli/Cargo.toml (update authors field)
