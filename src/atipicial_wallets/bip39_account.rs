...
/// A BIP-39 compatible atipicial account that uses mnemonic phrases for key generation and recovery.
///
/// This implementation follows the BIP-39 standard for generating and recovering atipicial accounts using
...
/// ```
/// use atipicial::atipicial_wallets::Bip39Account;
///
...
pub struct Bip39Account {
	/// The underlying atipicial account
	account: Account,
...
impl Bip39Account {
	...
	/// Returns a reference to the underlying Atipicial account
	pub fn account(&self) -> &Account {
		&self.account
	}
	/// Creates a new BIP-39 compatible atipicial account with a randomly generated mnemonic.
	///
	...
	/// Recovers a atipicial account from an existing BIP-39 mnemonic phrase and password.
	///
	/// This method will reconstruct the exact same atipicial account if provided with the same
