/// Atipicial Event Subscription Example
///
/// This example demonstrates how to subscribe to real-time events (notifications)
/// from Atipicial smart contracts using WebSocket connections and streaming.
use std::time::Duration;

#[tokio::main]
async fn main() -> Result<(), Box<dyn std::error::Error>> {
	println!("📡 Atipicial Event Subscription Example");
	println!("====================================");
	...
	println!("       .contracts(vec![FLAMINGO_SWAP_HASH, BURGERATC_HASH])");
	...
	println!("   • Atipicial WebSocket documentation");
