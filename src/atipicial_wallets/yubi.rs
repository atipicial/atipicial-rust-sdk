...
#[cfg(feature = "yubi")]
use crate::{
	atipicial_clients::public_key_to_address, atipicial_crypto::Secp256r1PublicKey, atipicial_error::WalletError,
	atipicial_wallets::WalletSigner, Address,
};
#[cfg(feature = "yubi")]
...
mod tests {
	...
	fn test_wallet_signer_creation() {
		...
		#[cfg(feature = "yubi")]
		{
			use crate::atipicial_wallets::WalletSigner;
			use p256::NistP256;
