...
These examples cover more complex Atipicial operations for application development.

## 📚 Examples

### Smart Contract Deployment (`deploy_contract.rs`)
Learn how to deploy smart contracts to Atipicial.

**What you'll learn:**
- Preparing AEF files and manifests
...
### AEP-17 Token Operations (`aep17_operations.rs`)
Work with Atipicial token standards.
...
- Familiarity with Atipicial transaction types
