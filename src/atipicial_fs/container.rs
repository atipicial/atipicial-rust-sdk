...
//! # AtipicialFs Container
//!
//! This module provides types and functions for working with AtipicialFs containers.

use chrono::{DateTime, Utc};
use serde::{Deserialize, Serialize};

use crate::atipicial_fs::types::{Attributes, ContainerId, OwnerId, PlacementPolicy};
...
/// Represents a storage container in AtipicialFs
#[derive(Debug, Clone, Serialize, Deserialize)]
