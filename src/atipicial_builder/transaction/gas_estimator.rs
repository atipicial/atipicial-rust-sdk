use crate::{
	atipicial_builder::{Signer, TransactionError},
	atipicial_clients::{APITrait, ProviderError},
};

/// Enhanced gas estimation utilities for Atipicial transactions
...
impl GasEstimator {
	...
	///
	/// # Arguments
	/// * `client` - The RPC client connected to a Atipicial node
