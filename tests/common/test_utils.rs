...
Common testing utilities and helper functions for the AtipicialRust test suite.
*/
...
pub const TESTNET_ENDPOINT: &str = "https://testnet1.atipicial.com:443";
pub const MAINNET_ENDPOINT: &str = "https://mainnet1.atipicial.com:443";
