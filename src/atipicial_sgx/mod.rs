//! # Atipicial SGX Support
//!
//! Support for running Atipicial blockchain operations in Intel SGX secure enclaves.
//!
//! ## Overview
//!
//! The atipicial_sgx module provides interfaces for running Atipicial blockchain operations
...
//! ```toml
//! [dependencies]
//! atipicial = { version = "0.5", features = ["sgx"] }
//! ```
//!
//! ## Architecture
//!
