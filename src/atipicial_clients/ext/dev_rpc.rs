...
//!
//! ```no_run
//! use atipicial_clients::{Provider, Http, Middleware, DevRpcMiddleware};
//! use atipicial_clients::core::transaction::transaction::Transaction;
//!
...
mod tests {
	...
	async fn test_snapshot() {
		if std::env::var("ATC_ENABLE_DEV_RPC_TESTS").is_err() {
			return;
		}
