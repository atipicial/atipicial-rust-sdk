...
//! # AtipicialFs Access Control
//!
//! This module provides types and functions for working with AtipicialFs access control.

use chrono::{DateTime, Utc};
use serde::{Deserialize, Serialize};
use std::fmt;

use crate::atipicial_fs::types::{AccessPermission, ContainerId, OwnerId};
...
/// Bearer token for delegated access to AtipicialFs resources
...
/// Session token for authenticated access to AtipicialFs resources
#[derive(Clone, Serialize, Deserialize)]
