...
pub fn generate_edl() -> &'static str {
    ...
    trusted {
        ...
        public sgx_status_t atipicial_verify_signature(
            [in, size=data_len] const uint8_t* data,
            size_t data_len,
        ...
        public sgx_status_t atipicial_calculate_hash(
            [in, size=data_len] const uint8_t* data,
            size_t data_len,
            [out, size=32] uint8_t* hash
        );
        
        public sgx_status_t atipicial_generate_keypair(
            [out, size=32] uint8_t* private_key,
            [out, size=64] uint8_t* public_key
        );
        
        public sgx_status_t atipicial_encrypt_wallet(
        ...
        public sgx_status_t atipicial_decrypt_wallet(
