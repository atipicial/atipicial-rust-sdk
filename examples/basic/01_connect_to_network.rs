...
This example demonstrates how to connect to Atipicial networks and perform basic queries.
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
	println!("{}", "🚀 AtipicialRust Basic Network Connection Example".cyan().bold());
	println!("{}", "=".repeat(50));

	// Define network endpoints
	let testnet_endpoints = vec!["https://testnet1.atipicial.com:443", "https://testnet2.atipicial.com:443"];

	let mainnet_endpoints = vec!["https://mainnet1.atipicial.com:443", "https://mainnet2.atipicial.com:443"];
	...
	if let Ok(provider) = HttpProvider::new("https://testnet1.atipicial.com:443") {
...
mod tests {
	...
	#[tokio::test]
	#[ignore = "requires a live Atipicial RPC endpoint"]
