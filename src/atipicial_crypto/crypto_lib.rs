//! CryptoLib functions for Atipicial.
//!
//! This module provides cryptographic functions that mirror the Atipicial CryptoLib native contract.
...
//!
//! ## Atipicial 3.9 Additions
//!
//! The following features were added in Atipicial 3.9:
...
///
/// This function was added in Atipicial 3.9 (HF_Faun).
///
/// # Arguments
///
...
///
/// ```rust
/// use atipicial::atipicial_crypto::crypto_lib::sha3_512;
///
...
///
/// ```rust
/// use atipicial::atipicial_crypto::crypto_lib::blake2b_512;
///
/// let data = b"Hello, Atipicial!";
...
///
/// This function was added in Atipicial 3.9 (HF_Echidna).
///
/// # Arguments
///
...
///
/// ```rust,no_run
/// use atipicial::atipicial_crypto::crypto_lib::verify_with_ed25519;
///
...
///
/// ```rust,no_run
/// use atipicial::atipicial_crypto::crypto_lib::recover_secp256k1;
///
