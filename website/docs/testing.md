...
This document outlines the testing strategy and testing practices for the Atipicial Rust Website.
...
The blockchain info component on the homepage displays live data from the Atipicial blockchain. The `BlockchainInfo.test.tsx` file provides comprehensive tests for this component, including:
...
it('fetches and displays blockchain information', async () => {
  ...
  expect(screen.getByText('/Atipicial:3.5.0/')).toBeInTheDocument();
