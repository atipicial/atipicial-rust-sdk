/// This example demonstrates message signing in Atipicial.
use atipicial::{
	atipicial_crypto::{HashableForVec, KeyPair},
	atipicial_protocol::{Account, AccountTrait},
	atipicial_wallets::{Wallet, WalletTrait},
};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
	...
	println!("\nIn Atipicial, message signing is used to prove ownership of a private key");
	...
	// Hash the message (Atipicial uses SHA256 for message signing)
	...
	let tampered_message = b"Hello, Atipicial! (tampered)";
