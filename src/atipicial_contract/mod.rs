//! # Atipicial Contract Module
//!
//! Comprehensive interfaces for interacting with Atipicial smart contracts and tokens.
//!
//! ## Overview
//!
//! The atipicial_contract module provides a robust set of interfaces for interacting with
//! various types of smart contracts on the Atipicial blockchain. This module abstracts
//! away the complexity of contract calls and state management, providing easy-to-use
//! APIs for developers.
//!
//! ## Key Features
//!
//! - **System Contracts**: Built-in interfaces for Atipicial system contracts:
//!   - ATC Token contract
//!   - GAS Token contract
//!   - Policy contract
...
//!
//! - **Token Standards**:
//!   - AEP-17 fungible token standard (similar to Ethereum's ERC-20)
//!   - AEP-11 non-fungible token standard (similar to Ethereum's ERC-721)
//!
//! - **Advanced Contract Interactions**:
//!   - Atipicial Name Service (NNS) domain resolution
//!   - Atipicial URI parsing and validation
//!   - Contract iterator support for handling large result sets
//!
//! - **Famous Contract Integrations**:
//!   - Flamingo Finance DeFi ecosystem
//!   - AtipicialburgerAtipicial (bATC) staking contract
//!   - GrandShare voting and proposals
//!   - AtipicialCompound yield aggregator
//!
//! - **Developer Tools**:
...
//!
//! ```no_run
//! use atipicial::atipicial_contract::{GasToken, PolicyContract, FungibleTokenContract, FungibleTokenTrait};
...
//!
//!     // 3. Working with a custom AEP-17 token
...
//! use atipicial::atipicial_types::AefFile;
//! use atipicial::atipicial_clients::{HttpProvider, RpcClient};
//! use std::fs;
//!
...
pub use atipicial_token::*;
pub use atipicial_uri::*;
