//! Hardfork definitions for Atipicial blockchain.
//!
//! This module defines the various hardforks that have been implemented in the Atipicial blockchain.
...
/// Represents the various hardforks implemented in the Atipicial blockchain.
///
...
pub enum Hardfork {
	/// Aspidochelone hardfork - First hardfork after Atipicial launch
...
impl Hardfork {
	...
	pub fn description(&self) -> &'static str {
		match self {
			Hardfork::Aspidochelone => "First hardfork after Atipicial launch",
