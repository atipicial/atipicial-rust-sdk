...
//! # Atipicial Wallets
//!
//! Wallet management for the Atipicial blockchain.
//!
//! ## Overview
//!
//! The atipicial_wallets module provides comprehensive wallet management functionality for the Atipicial blockchain.
//! It includes:
//!
...
//! with the Atipicial blockchain in a secure manner.
//!
//! ## Examples
//!
...
//!
//! ```rust,no_run
//! use atipicial::atipicial_wallets::Wallet;
...
//!     
//!     // Encrypt accounts before persisting to AEP-6 JSON.
