//! Atipicial Signer Middleware Example
//!
//! This example demonstrates transaction signing middleware for Atipicial.
//! Note: This is a conceptual example showing the intended API structure.

#[tokio::main]
async fn main() -> eyre::Result<()> {
	println!("✍️ Atipicial Signer Middleware Example");
	println!("===================================");
