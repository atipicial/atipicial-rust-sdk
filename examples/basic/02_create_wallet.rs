...
This example demonstrates how to create and manage wallets in AtipicialRust.
...
- Store private keys encrypted (AEP-2)
*/

use colored::*;
use atipicial::{
	atipicial_crypto::KeyPair,
	atipicial_types::{ScriptHash, ScriptHashExtension},
};

#[tokio::main]
async fn main() -> Result<(), Box<dyn std::error::Error>> {
	println!("{}", "💼 AtipicialRust Basic Wallet Creation Example".cyan().bold());
	println!("{}", "=".repeat(50));
	...
	println!("  • Use AEP-2 encryption for key storage");
