//! Serde serialization/deserialization helpers for Atipicial types.
//!
...
//! in the Atipicial blockchain protocol.
//!
//! # Overview
//!
//! The helpers in this module are designed to be used with serde's `serialize_with`
//! and `deserialize_with` attributes. They handle various Atipicial-specific types including:
//!
...
//! - **Script hashes**: Atipicial address representations
...
//!
//! ```rust,no_run
//! use atipicial::atipicial_types::serde_with_utils::{serialize_h160, deserialize_h160};
...
//! - [`serialize_script_hash`] / [`deserialize_script_hash`]: Atipicial script hashes
//!
//! ## Numeric Types
...
///
/// ```rust
/// use atipicial::atipicial_types::serde_with_utils::{deserialize_h160};
/// use primitive_types::H160;
/// use serde::{Serialize, Deserialize};
///
/// #[derive(Serialize, Deserialize)]
...
///
/// ```rust
/// use atipicial::atipicial_types::serde_with_utils::{serialize_bytes, deserialize_bytes};
/// use serde::{Serialize, Deserialize};
///
/// #[derive(Serialize, Deserialize)]
/// struct Example {
...
///
/// ```rust
/// use atipicial::atipicial_types::serde_with_utils::{serialize_u256, deserialize_u256};
...
///
/// ```rust
/// use atipicial::atipicial_types::serde_with_utils::{serialize_u32, deserialize_u32};
/// use serde::{Serialize, Deserialize};
///
/// #[derive(Serialize, Deserialize)]
/// struct Example {
...
///
/// ```rust
/// use atipicial::atipicial_types::serde_with_utils::{serialize_u64, deserialize_u64};
/// use serde::{Serialize, Deserialize};
///
/// #[derive(Serialize, Deserialize)]
/// struct Example {
...
///
/// Converts an address string to a ScriptHash using the Atipicial address parsing logic.
///
/// # Errors
///
/// Returns an error if the string is not a valid Atipicial address.
...
///
/// ```rust
/// use atipicial::atipicial_types::serde_with_utils::{serialize_script_hash, deserialize_script_hash};
...
where
	S: Serializer,
{
	// Output big-endian hex with 0x prefix (Atipicial display format)
...
///
/// ```rust,no_run
/// use atipicial::atipicial_types::serde_with_utils::serialize_private_key;
/// use atipicial::atipicial_crypto::Secp256r1PrivateKey;
/// use serde::Serialize;
///
/// #[derive(Serialize)]
/// struct Example {
...
///
/// ```rust,no_run
/// use atipicial::atipicial_types::serde_with_utils::deserialize_public_key;
/// use atipicial::atipicial_crypto::Secp256r1PublicKey;
...
///
/// ```rust,no_run
/// use atipicial::atipicial_types::serde_with_utils::serialize_public_key;
/// use atipicial::atipicial_crypto::Secp256r1PublicKey;
/// use serde::Serialize;
///
/// #[derive(Serialize)]
...
///
/// ```rust
/// use atipicial::atipicial_types::serde_with_utils::{serialize_h256, deserialize_h256};
...
///
/// ```rust
/// use atipicial::atipicial_types::serde_with_utils::{serialize_vec_h256, deserialize_vec_h256};
/// use primitive_types::H256;
/// use serde::{Serialize, Deserialize};
///
/// #[derive(Serialize, Deserialize)]
