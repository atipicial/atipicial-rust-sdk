...
use crate::atipicial_protocol::AtipicialBlock;
use futures::stream::Stream;
use std::{error::Error, pin::Pin};

/// The JSON-RPC client event API for Atipicial.
pub(crate) trait AtipicialRustRxTrait {
	...
	) -> Pin<Box<dyn Stream<Item = Result<AtipicialBlock, Box<dyn Error>>> + Send>>;
