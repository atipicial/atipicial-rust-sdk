...
describe('ThemeContext', () => {
  ...
  it('toggles theme when toggleTheme is called', () => {
    ...
    expect(window.localStorage.getItem('atipicialRustTheme')).toBe('light');
    ...
    // Verify localStorage was updated
    expect(window.localStorage.getItem('atipicialRustTheme')).toBe('dark');
  });

  it('initializes from localStorage when a theme is stored', () => {
    // Set initial theme in localStorage
    window.localStorage.setItem('atipicialRustTheme', 'light');
